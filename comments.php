        ...
        <div class="comments-main">
            ...
            if (comments_open()) {
                ...
                $args = array(
                    ...
                    'comment_field' => get_meme() . '<div id="comments_edit" placeholder="' . esc_attr__('还不快点说点什么呀……', 'akina') . '" contenteditable="true" class="textarea" onmouseup="comments_edit_mouseup();" onmouseout="comments_edit_mouseout();" onkeyup="comments_edit_keyup();"></div><input name="comment" type="hidden" />',
                    'comment_notes_after' => '',
