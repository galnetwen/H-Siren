...
?>
    ...
    <section id="comments" class="comments">
        ...
        <div class="comments-main">
            ...
            <?php
				//meme
				$meme_json = json_decode(@file_get_contents(get_stylesheet_directory_uri().'/OwO/meme.json'),true);
				...
				foreach($meme_json as $key1 => $val1){
					...
					foreach($val1['value'] as $key2 => $val2){
                        ...
                        $meme_html .= '<li onclick="meme_click(this);"><img src="'.get_stylesheet_directory_uri().'/OwO'.$val1['path'].$val2.'"></li>
                        ';
					}
					$meme_html .= '</ul>
						</div>
